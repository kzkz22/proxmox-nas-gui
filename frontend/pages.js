import { pages as diagnosticsPages } from "./diagnostics/pages.js";
import { pages as sambaPages } from "./samba/pages.js";
import { pages as storagePages } from "./storage/pages.js";

const byId = Object.fromEntries(
  [...sambaPages, ...storagePages, ...diagnosticsPages].map((page) => [page.id, page])
);
...
export const PAGES = [
  "shares", "pools", "binds", "sleep", "diag", "users", "groups", "settings",
].map((id) => {
  const page = byId[id];
